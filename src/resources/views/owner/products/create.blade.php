                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('owner.products.store') }}">
                        ...
                        <div class="p-2 w-full mt-3 flex justify-around">
                            <button type="button" onclick="location.href='{{ route('owner.products.index') }}'" class="mx-auto text-white bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">
                                戻る
                            </button>
