                        ...
                        <div class="lg:w-2/2 md:w-2/3 mx-auto">
                            ...
                            <form method="POST" action="{{ route('admin.owners.update', [ "owner" => $owner->id ]) }}">
                                ...
                                <div class="-m-2 mx-auto">
                                    ...
                                    <div class="p-2 w-2/2 mx-auto">
                                        <div class="relative">
                                            <label class="leading-7 text-sm text-gray-600">shop name</label>
                                            <div class=class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                {{ $owner->shop->name }}
                                            </div>
                                        </div>
                                    </div>
