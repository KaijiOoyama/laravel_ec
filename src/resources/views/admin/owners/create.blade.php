                        ...
                        <div class="lg:w-2/2 md:w-2/3 mx-auto">
                            <div class="-m-2 mx-auto">
                                ...
                                <div class="p-2 w-full mt-3 flex justify-around">
                                    <button onclick="location.href='{{ route('admin.owners.index') }}'" class="mx-auto text-white bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">
                                        戻る
                                    </button>
                                    <button class=" mx-auto text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">
                                        登録する
                                    </button>
                                </div>
                            </div>
